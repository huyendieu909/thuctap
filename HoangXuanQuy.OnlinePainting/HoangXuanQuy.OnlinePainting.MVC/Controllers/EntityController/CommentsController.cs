...
namespace HoangXuanQuy.OnlinePainting.MVC.Controllers.EntityController
{
    public class CommentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CommentId,Content,CommentDate,Rating,LikeCount,CustomerId,PaintingId,ParentCommentId")] Comment comment)
        {
            ...
            ViewData["CustomerId"] = new SelectList(_context.Customers, "Id", "Id", comment.CustomerId);
            ViewData["PaintingId"] = new SelectList(_context.Paintings, "PaintingId", "Title", comment.PaintingId);
